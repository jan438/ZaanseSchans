...
my_canvas.drawImage("Photos/pauw-oud.jpg", 50, 400, 320, 212.5)
my_canvas.drawImage("Photos/pauw-nieuw.jpg", 350, 400, 320, 212.5)
renderPDF.draw(scaleSVG("SVG/molen-de-paauwbw.svg", 0.25), my_canvas, 300, 100)
my_canvas.save()
key = input("Wait")
