...
renderPDF.draw(scaleSVG("SVG/molen-de-pauw_cropag.svg", 0.25), my_canvas, 100.0, 500.0)
renderPDF.draw(scaleSVG("SVG/paauwpngimportinkscape.svg", 0.25), my_canvas, 300.0, 500.0)
my_canvas.save()
key = input("Wait")
